...
import 'registrierung_model.dart';
export 'registrierung_model.dart';

/// new page for registration, same like in login there must be an input for
/// the database
...
class _RegistrierungWidgetState extends State<RegistrierungWidget> {
  late RegistrierungModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => RegistrierungModel());
