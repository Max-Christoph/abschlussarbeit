...
class _RegisterScreenState extends State<RegisterScreen> {
  ...
  Future<void> _register() async {
    if (_formKey.currentState!.validate()) {
      ...
      final authService = AuthService('your_username', 'your_password', _dbAddress); // Setzen Sie die DB-Anmeldeinformationen
      final success = await authService.register(_username, _password);
